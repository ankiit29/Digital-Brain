    ...
    <div className="max-w-lg mx-auto">
      <div className="space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              } placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 transition-all bg-white`}
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white py-3.5 px-4 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow flex items-center justify-center gap-2"
        >
          {isLoading ? (
            <>
